...
The [AWS CLI](https://aws.amazon.com/cli/) works with Fil One out of the box. Install it, configure your credentials, and use `--endpoint-url https://<region>.s3.filonecontent.com` on every command — or set it as a profile default so you never have to type it.
