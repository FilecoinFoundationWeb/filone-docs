...
|---------|-------|-------|
| Region | `eu-west-1` | |
| Object Lock | Always on | Every bucket has WORM compliance built in. |
...
<div class="card-grid">
  <a href="/storage/object-lock"><strong>Object Lock</strong><span>Configure retention policies — enabled on every bucket by default.</span></a>
