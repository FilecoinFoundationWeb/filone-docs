...
Note that closing an account blocks access but does not purge data. For the full picture — versioned buckets, Object Lock, account closure, and residual data — see [Data Deletion](/security/data-deletion).
