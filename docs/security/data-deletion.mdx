...
For questions about how the underlying network handles deleted data — replication, or the proof cycle that storage providers run — contact support and we will get you a direct answer.
