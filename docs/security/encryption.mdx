...
All connections to the regional endpoints (`https://eu-west-1.s3.filonecontent.com`, `https://us-east-1.s3.filonecontent.com`) use **TLS**. HTTP connections are rejected. Your data is always encrypted during transmission between your application and the Fil One endpoint.
