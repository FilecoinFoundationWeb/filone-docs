...
| Feature | Status |
|---------|--------|
| MCP endpoint / MCP server for Claude, Cursor, and other clients | Not built. Connecting AI clients is what the [AI Agent Toolkit](/app/ai-agent-toolkit) will cover. |
